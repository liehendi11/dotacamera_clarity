 ...
 */
package skadistats.clarity.examples.new_combat_log;
 ...
 * @author Hendi
 */
public class NewCombatLogEntry implements CombatLogEntry {
    
    private final StringTable combatLogNames;
    private final DotaUserMessages.CMsgDOTACombatLogEntry e;

    public NewCombatLogEntry(StringTable combatLogNames, DotaUserMessages.CMsgDOTACombatLogEntry entry) {
